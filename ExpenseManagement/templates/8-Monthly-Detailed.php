<?php 
    ...
    if ($mthexp !== NULL) {
        foreach ($mthexp as $row) {
            $labels[] = date("F Y", strtotime($row->Date));
                    ...
                    <table id="expense-table">
                        <thead>
                            <tr>
                                ...
                                <th style="font-family: 'Arial Black', Gadget, sans-serif; font-weight: bold;">Month</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
...
<script>
    ...
    async function downloadPDF() {
        ...
        const titleText = "Expenses Incurred Between <?php echo date('F, Y', strtotime($_POST['mthfrom'])) ?> and <?php echo date('F, Y', strtotime($_POST['mthto'])) ?>";
