<?php 
    ...
    if ($yrexp !== NULL) {
        foreach ($yrexp as $row) {
            $labels[] = date("M Y", strtotime($row->Date));
            ...
            <div class="card">
                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <h4 style="font-family:'Arial Black', Gadget, sans-serif; font-size: 1.3em; text-align: center; margin: 0;">
                        Expenses incurred between <?php echo $_SESSION['yrfrom'] ?> and <?php echo $_SESSION['yrto'] ?> :
                    </h4>
                    <div>
                    ...
                    <table id="expense-table">
                        <thead>
                            <tr>
                                ...
                                <th style="font-family: 'Arial Black', Gadget, sans-serif; font-weight: bold;">Item</th>
...
<script>
    ...
    async function downloadPDF() {
        ...
        const titleText = "Expenses Incurred Between <?php echo $_SESSION['yrfrom'] ?> and <?php echo $_SESSION['yrto'] ?>";
        ...
        doc.save("Yearly_Expense_Report.pdf");
    }
</script>
